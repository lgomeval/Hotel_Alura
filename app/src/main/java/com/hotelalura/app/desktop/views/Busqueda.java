...
import com.hotelalura.app.controller.HuespedesController;
import com.hotelalura.app.controller.ReservasController;
...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		panel.addTab("Huéspedes", new ImageIcon(Busqueda.class.getResource("images/pessoas.png")), tbHuespedes,
				null);
		...
		panel.addTab("Reservas", new ImageIcon(Busqueda.class.getResource("images/reservado.png")), tbReservas,
				null);
		...
		logo.setIcon(new ImageIcon(Busqueda.class.getResource("images/Ha-100px.png")));
